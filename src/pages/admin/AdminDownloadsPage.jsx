...
export default function AdminDownloadsPage() {
  ...
  const totalDownloadsNumber = useMemo(() => {
    return games.reduce((acc, g) => acc + (g.downloadCount || 0), 0)
  }, [games])
  ...
  const licenseBreakdown = useMemo(() => {
    const counts = {}
    games.forEach((g) => {
      const type = g.license || 'Free-to-Play'
      counts[type] = (counts[type] || 0) + (g.downloadCount || 0)
    })
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-sm text-gray-400 mt-0.5">
          Detailed metrics of legal PC game installations, traffic patterns, and community engagement.
        </p>
      </div>
          ...
          {leaderboard.map((game, index) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-primary-400 font-medium">{game.downloads || '0'} downloads</p>
              </div>
